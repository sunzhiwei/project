...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>
		...
		<td width="25%" >
			<input value="${map.province}" disabled="disabled" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getCombobox/csf',panelHeight:'100', editable:true"/>
		</td>
...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>
		...
		<td width="25%" >
			<input value="${map.install_province}" disabled="disabled" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getCombobox/csf',panelHeight:'100', editable:true"/>
		</td>
	</tr>
	<tr>
...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>	
		...
		<td width="25%" ><label>${map.service_status}</label></td>
	</tr>
	<tr>	
