...
public class HxRepairReceiptController {
	...
	public String saveRepairReceipt(HttpServletRequest request,@RequestBody HxServiceTicketVO serviceTicketVO) throws Exception{
		...
		try {
			String serviceId = repairReceiptService.saveRepairReceipt(serviceTicketVO,sysUser);
	...
	public String selectTroubleView(){
		return "servicemanage/RepairReceipt/SelectTroubleView";
	}
	
	@RequestMapping(value="/getHxMaintenanceTree/{type}", produces="text/plain;charset=utf-8")
	@ResponseBody
	public String getHxMaintenanceTree(@PathVariable String type){
