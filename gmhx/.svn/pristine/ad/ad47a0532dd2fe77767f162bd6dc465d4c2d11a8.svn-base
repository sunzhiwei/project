...
public class JbpmService {
	...
	*/
	public void completeTask(JbpmWorkEntity jBPMWorkEntity,String outGoing,String approveComment,Map<String,Object> variables){
		String positionType  ="";
		if(jBPMWorkEntity.getProcessInstanceId().startsWith("SP")){
		...
		}else if(jBPMWorkEntity.getProcessInstanceId().startsWith("MP")){
		...
		Task task = taskService.createTaskQuery().candidate(getCurrentUsername(positionType)).processInstanceId(jBPMWorkEntity.getProcessInstanceId()).uniqueResult();
		if(task!=null){
	...
	* @throws
	*/
	public void completeTask(JbpmWorkEntity jBPMWorkEntity,String outGoing,String approveComment,Map<String,Object> variables,String positionType){
		Task task = taskService.createTaskQuery().candidate(getCurrentUsername(positionType)).processInstanceId(jBPMWorkEntity.getProcessInstanceId()).uniqueResult();
		if(task!=null){
			taskService.completeTask(task.getId(),outGoing,variables);
		}else{
