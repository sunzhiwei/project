		...
		<div data-options="region:'north',title:'查询条件',border:false,collapsible:false" style="height: 120px; overflow: hidden;">
			<form id="searchForm">
				...
				<tr>
					...
					<td width="5%"></td>
             	    <td width="5%">发货单位</td>
					<td width="5%"><input class="easyui-combobox" name="sendUnit" placeholder="请选择发货单位" class="span2" data-options="url:'${ctx}/hxCode/getCombobox/jg'"/></td>            
					<td width="5%"></td>
					<td width="55"></td>
               </tr>
			   <tr>
			        <td width="5%">收货单位</td>
					<td width="5%"><input class="easyui-combobox" name="receiveUnit" placeholder="请选择收货单位" class="span2" data-options="url:'${ctx}/hxCode/getCombobox/jg'"/></td>            
					<td width="5%"></td>
                    <td width="5%">承运单位</td>
					...
					<td width="30%" align="left"><a href="#" id="query" class="easyui-linkbutton" iconCls="icon-search">查询</a></td>
				</tr>
				</table>
			</form>
		</div>
