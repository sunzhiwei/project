		...
		<form id="form" method="post">
			...
			<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse;">
				...
				<tr>
					...
					<td width="25%"><input id="fittingPid" name="fittingPid"  type="text" placeholder="请选择物料上级机构" editable="true" class="easyui-combobox" class="span2" value="" data-options="url:'${ctx}/hxCode/getOrgCombobox'" ></td>
				</tr>
				<tr>
