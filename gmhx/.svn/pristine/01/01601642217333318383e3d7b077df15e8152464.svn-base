...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	<tr>
		...
		<td width="25%" align="center">申请单位</td><td width="25%" ><label>${distanceApply.applyUnit}</label></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="25%" align="center">国美代码</td><td width="25%" ><label>${distanceApply.gomeCode}</label></td>
	</tr>
	<tr>
