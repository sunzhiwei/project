...
public class HxFittingController {
	...
	public String getHxFittingPageList(HttpServletResponse response, Page page, HxFitting hxFitting,
			...
			String brand, String suitModel) throws Exception{
	...
	@RequestMapping(value="/viewHxFitting/{fittingCode}")
	public ModelAndView viewHxFitting(@PathVariable String fittingCode) throws Exception{
