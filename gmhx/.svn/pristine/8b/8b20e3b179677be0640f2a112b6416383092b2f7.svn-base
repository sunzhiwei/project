		...
		<div data-options="region:'north',title:'查询条件',border:false,collapsible:true,onBeforeCollapse:function(){clos();},onBeforeOpen:function(){ope();}"  style="height: 150px; overflow: hidden;">
			<form id="searchForm">
				<table class="table table-hover table-condensed" width="100%;" style="padding:10px 10px 10px 10px">
					<tr>
						<td width="7%">服务单号</td> 
						<td width="12%"><input name="serviceTicket.serviceId" placeholder="请输入查询条件" class="span2" ></td>
						<td width="7%">机型</td> 
						<td width="12%"><input name="serviceProduct.machineType" placeholder="请输入查询条件" class="span2" ></td>
						<td width="7%">国美代码</td> 
						...
						<td width="7%">机器条码</td>
						<td width="12%"><input name="serviceProduct.machineCode" placeholder="请输入查询条件" class="span2" ></td>
					...
					<tr>
						<td>固定电话</td> 
						<td><input name="serviceCustomer.telephone" placeholder="请输入查询条件" class="span2" ></td>
						<td>合同编码</td> 
						<td><input name="serviceProduct.bargainCode" placeholder="请输入查询条件" class="span2" ></td>
						<td>创建单位</td> 
						<td><input name="serviceTicket.createOrganizationS" placeholder="请输入查询条件" class="span2" ></td>
						<td>接收分部</td> 
						<td><input name="serviceTicket.center" placeholder="请输入查询条件" class="span2" ></td>
						<td>创建日期</td> 
						<td>
