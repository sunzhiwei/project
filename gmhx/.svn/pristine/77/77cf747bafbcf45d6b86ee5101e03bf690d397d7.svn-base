...
<body>
	...
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div
			data-options="region:'north',title:'查询条件',border:false,collapsible:false" style="height: 120px; overflow: hidden;">
			<form id="searchForm">
				<table class="table table-hover table-condensed"
					...
					<tr>
						...
						<td width="5%"></td>
						<td width="5%">收货单位</td>
						<td width="5%"><input name="receiveUnit"  class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getOrgCombobox'"/></td>
						<td width="5%"></td>
						<td width="55%"></td>
					</tr>
					<tr>	
						...
						<td width="5%"></td>
						<td width="5%">状态</td>
						<td width="5%"><input class="easyui-combobox" name="state" data-options="url:'${ctx}/hxCode/getCombobox/ybzt'" /></td>
						<td width="5%"></td>
					    <td width="5%">更新日期</td>
					    <td width="30%">
						...
						<td width="30%" align="left"><a href="#" id="query"
