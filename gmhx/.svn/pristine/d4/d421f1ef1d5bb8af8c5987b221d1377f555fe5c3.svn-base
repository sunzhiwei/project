...
<body>
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'north',title:'查询条件',border:false,collapsible:false" style="height: 180px; overflow: hidden;">
			<form id="searchForm">
				<table class="table table-hover table-condensed" style="width:100%; padding: 7px 80px 0px 80px">
					<tr>
						...
						<td width="5%"></td>
						<td width="5%">配件分类:</td>
						<td width="5%"><input class="easyui-combobox" name="fittingType" data-options="url:'${ctx}/hxCode/getCombobox/cpfl', editable:false"/></td>
						<td width="5%"></td>
						<td width="55%"></td>
					</tr>
					<tr>
