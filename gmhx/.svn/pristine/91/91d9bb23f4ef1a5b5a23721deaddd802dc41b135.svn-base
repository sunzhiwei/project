...
public class HxParcelReceiptController {
	...
	@ResponseBody
	public String getHxParcelReceiptPageList(HttpServletRequest request,Page page, HxParcelDelivery hxParcelReceipt,
...
//		hxParcelReceipt.setFittingPositionId(sysUser.getFittingPositionId());
	...
	public ModelAndView exportExcel(HxParcelDelivery hxParcelReceipt, String tableField, String tableHeader, HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		List<Map<String, Object>> list = hxParcelReceiptService.getHxParcelReceiptExport(hxParcelReceipt);
	...
	@RequestMapping(value="/showView/{orgId}")
	public ModelAndView showView(@PathVariable(value = "orgId") String orgId){
