...
<script type="text/javascript">
	...
	$(function() {
		dataGrid = $('#dataGrid').datagrid({
			...
			nowrap : false,
			striped : true,
			height : document.body.clientHeight - 195,
			collapsible : true,
			autoRowHeight : false,
			remoteSort : false,
			idField : 'limitId',
...
<body>
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'north',title:'查询条件',border:false,collapsible:false" style="height: 195px; overflow: hidden;">
			<form id="searchForm">
				<table class="table table-hover table-condensed" style="width:100%; padding: 7px 80px 0px 80px">
					...
					<tr>
						...
						<td width="5%"></td>
						<td width="10%">更改原因:</td>
						<td width="5%"><input name="limitOperateReason" placeholder="输入查询条件" editable="false" class="easyui-combobox" class="span2" value="" data-options="url:'${ctx}/hxCode/getCombobox/ggyy'"/></td>
						<td width="5%"></td>
					</tr>
					<tr>
						<td width="10%">现金:</td>
						...
						<td width="5%"></td>
						<td width="10%">信用:</td>
						<td width="5%"><input name="limitCredit" placeholder="输入查询条件" class="span2" /></td>
						<td width="5%"></td>
						<td width="10%">物料:</td>
