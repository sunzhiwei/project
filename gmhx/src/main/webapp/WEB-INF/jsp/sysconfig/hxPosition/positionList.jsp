			...
			<form id="searchForm">
				...
				<table class="table table-hover table-condensed" style="width:100%; padding: 7px 80px 0px 80px">
					<tr>
						...
						<td width="5%"></td>
						<td width="10%">岗位类型</td>
						<td width="5%"><input id="positionType" name="positionType" type="text" placeholder="请选择岗位类型" editable="false" class="easyui-combobox" class="span2" value="" data-options="url:'${ctx}/hxCode/getCombobox/gwlx'" ></td>
						<td width="5%"></td>
