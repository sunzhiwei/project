		...
		<form id="form" method="post">
			...
			<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse;">
				...
				<tr>
					...
					<td width="25%" colspan="3"><input id="positionCode" name="positionCode" type="text" placeholder="请输入岗位代码" value="${position.positionCode}" <c:if test="${position.fromType==1}">readonly</c:if>></td>	
				</tr>
				<c:if test="${position.fromType==1}">
					<td width="25%" align="center">组织机构：</td>
					<td width="25%" colspan="3"><input id="positionOrgName" name="positionOrgName" type="text" placeholder="请输入组织机构"  value="${position.positionOrgName}" readonly/></td>
				</c:if>
