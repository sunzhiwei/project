		...
		<form id="form" method="post">
			...
			<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse;">
				<tr>
					...
					<td width="25%"><input id="userLoginName" name="userLoginName" type="text" placeholder="请输入登录名" value="${user.userLoginName}" readonly></td>
				</tr>
				<tr>
				...
				<tr>
                    ...
                    <td width="25%"><input name="userSex" id="userSex" type="text" placeholder="请输入性别" editable="false" class="easyui-combobox" 
                                        data-options="url:'${ctx}/hxCode/getCombobox/xb?value=${user.userSex}',required:true"></td>
				</tr>
				<tr>
                    ...
                    <td width="25%"><input id = "userEducation" name="userEducation" type="text" placeholder="请输入学历" class="easyui-combobox" editable="false" 
                                        data-options="url:'${ctx}/hxCode/getCombobox/xl?value=${user.userEducation}',required:true"/></td>
