		...
		<form id="form" method="post">
			...
			<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse;">
				<tr>
					...
					<td width="25%" colspan="3"><input id="limitOrgId" name="limitOrgId" type="text" placeholder="请输入机构名称" editable="false" class="easyui-combobox" class="span2" value="" data-options="url:'${ctx}/hxCode/getOrgCombobox'"></td>
				</tr>
				<tr>
