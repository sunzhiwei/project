...
<script type="text/javascript">
	...
	function validateForm(){
		...
		var limitCredit = $("#limitCredit").val();
		...
		<form id="form" method="post">
			...
			<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse;">
				<tr>
					...
					<td width="25%"><input id="limitId" name="limitId" type="hidden" value="${limit.limitId}"><input id="limitOrgId" name="limitOrgId" type="text" placeholder="请输入机构名称" editable="false" class="easyui-combobox" class="span2" value="${limit.limitOrgId}" data-options="url:'${ctx}/hxCode/getOrgCombobox'"></td>
				...
				<tr>
					...
					<td width="25%"><input id="limitCash" name="limitCash" type="text" placeholder="请输入现金额度"></td>
					<td width="25%" align="center">信用额度<font color="red">*</font></td>
					<td width="25%"><input id="limitCredit" name="limitCredit" type="text" placeholder="请输入信用额度"></td>
				</tr>
				<tr>
