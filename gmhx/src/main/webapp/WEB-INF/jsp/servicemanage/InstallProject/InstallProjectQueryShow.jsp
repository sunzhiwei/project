...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	...
	<tr>
		...
		<td width="25%" >
			<input type="text" disabled="disabled" value="${map.province}" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getCombobox/csf',panelHeight:'100', editable:true,required:true">
		</td>
...
<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
	<tr>
		...
		<td width="25%" >
			<input type="text" disabled="disabled" value="${map.install_unit}" class="easyui-combobox" data-options="url:'${ctx}/installReceipt/getServices',required:true">
		</td>
	</tr>
	<tr>
		<td width="25%" align="center">销售门店<font color="red">*</font></td>
		<td width="25%" >
			<input disabled="disabled" type="text" value='${map.sale_market}' class="easyui-combobox" data-options="url:'${ctx}/installReceipt/getStore',required:true">
		</td>
		<td width="25%" align="center">安装省份<font color="red">*</font></td>
		<td width="25%" >
			<input disabled="disabled" type="text" value='${map.province}' class="easyui-combobox" data-options="url:'${ctx}/hxCode/getCombobox/csf',panelHeight:'100',editable:true,required:true">
		</td>
	</tr>
	<tr>
