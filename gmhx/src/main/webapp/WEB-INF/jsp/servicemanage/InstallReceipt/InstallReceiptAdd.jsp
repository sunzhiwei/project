...
<form id="formCustomer" method="post">
	...
	<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
		<tr>
			...
			<td width="30%"><input name="customerName" type="text"   class="easyui-validatebox span2" value="${customerProduct.customerName}" data-options="required:true"></td>
			<td width="20%">客户类别<font color="red">*</font></td>
			<td width="30%">
				<input class="easyui-combobox" name="customerType" data-options="url:'${ctx}/hxCode/getCombobox/khlb?value=${customerProduct.customerType}',panelHeight:'auto', editable:false"/>
			</td>
		</tr>
		<tr>
			<td>性别</td>
		...
		<tr>
			...
			<td><input name="province" type="text" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getCombobox/csf',panelHeight:'auto', editable:true,required:true" value="${customerProduct.province}"></td>
			<td>区号</td>
...
<form id="formTicket" method="post">
	...
	<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
		...
		<tr>
			...
			<td><input id="warrantyPolicy" name="warrantyPolicy" class="easyui-combobox" data-options="url:'${ctx}/hxCode/getCombobox/bxzc',panelHeight:'auto',panelHeight:'auto',editable:false"></td>
			<td>产品外观满意度<font color="red">*</font></td>
			<td>
				<input id="productExteriorSatisfaction" name="productExteriorSatisfaction" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/myd',panelHeight:'auto',editable:false ">
			</td>
		</tr>
		<tr>
			<td>产品外观重要性<font color="red">*</font></td>
			<td><input id="productExteriorSignificance" name="productExteriorSignificance" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/zyx',panelHeight:'auto',editable:false "></td>
			<td>产品质量满意度<font color="red">*</font></td>
			<td>
				<input id="qualitySatisfaction" name="qualitySatisfaction" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/myd',panelHeight:'auto',editable:false ">
			</td>
		</tr>
		<tr>
			<td>产品质量重要性<font color="red">*</font></td>
			<td>
				<input id="qualitySignificance" name="qualitySignificance" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/zyx',panelHeight:'auto',editable:false ">
			</td>
			<td>价格满意度<font color="red">*</font></td>
			<td><input id="priceSatisfaction" name="priceSatisfaction" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/myd',panelHeight:'auto',editable:false "></td>
		</tr>
		<tr>
			<td>价格重要性<font color="red">*</font></td>
			<td><input id="priceSignificance" name="priceSignificance" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/zyx',panelHeight:'auto',editable:false "></td>
			<td>服务满意度<font color="red">*</font></td>
			<td><input id="serviceSatisfaction" name="serviceSatisfaction" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/myd',panelHeight:'auto',editable:false "></td>
		</tr>
		<tr>
			<td>服务重要性<font color="red">*</font></td>
			<td><input id="serviceSignificance" name="serviceSignificance" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/zyx',panelHeight:'auto',editable:false "></td>
			<td>生理感受满意度<font color="red">*</font></td>
			<td><input id="physiologySatisfaction" name="physiologySatisfaction" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/myd',panelHeight:'auto',editable:false "></td>
		</tr>
		<tr>
			<td>生理感受重要性<font color="red">*</font></td>
			<td><input id="physiologySignificance" name="physiologySignificance" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/zyx',panelHeight:'auto',editable:false "></td>
			<td>是否二次安装<font color="red">*</font></td>
			<td><input id="isDoubleInstall" name="isDoubleInstall" class="easyui-combobox"  data-options="url:'${ctx}/hxCode/getCombobox/sf',panelHeight:'auto',editable:false "></td>
		</tr>
	 	<tr>
			<td>备注</td>
