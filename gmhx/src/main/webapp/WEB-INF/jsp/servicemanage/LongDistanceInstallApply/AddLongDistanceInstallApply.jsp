...
<form id="longDistanceForm" method="post">
	...
	<table border=1 style="cellSpacing:1;cellPadding:3;width:100%;background-color:#eff5ff;border-collapse:collapse">
		<tr>
			...
			<td width="30%"><input class="easyui-combobox" name="applyUnit" data-options="url:'${ctx}/installReceipt/getWD',panelHeight:'100',required:true,editable:true"/></td>
		...
		<tr>
			...
			<td><input name="machineType" class="easyui-combobox" data-options="url:'${ctx}/installReceipt/getModel',onSelect: function(rec){fillForm(rec)},panelHeight:'auto'"/></td>
			<td>国美代码</td>
